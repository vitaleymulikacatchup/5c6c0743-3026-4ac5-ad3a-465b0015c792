...
export const metadata: Metadata = {
  title: "Grand Vista Hotel - Luxury Hospitality & Premium Accommodations",
  description: "Experience world-class luxury at Grand Vista Hotel. Premium rooms, exceptional amenities, award-winning service, and breathtaking views in the heart of the city.",
  keywords: "luxury hotel, premium accommodations, 5-star hotel, grand vista, hospitality, spa, fine dining, business travel, vacation",
  metadataBase: new URL("https://grandvistahotel.com"),
  alternates: {
    canonical: "https://grandvistahotel.com"
  },
  openGraph: {
    title: "Grand Vista Hotel - Luxury Hospitality Experience",
    description: "Indulge in world-class accommodations with breathtaking views and exceptional service at Grand Vista Hotel",
  ...
  twitter: {
    ...
    title: "Grand Vista Hotel - Luxury Hospitality Experience",
    description: "Experience luxury accommodations and exceptional service",
